...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--input", type=str, default="datasets/default-demo",
...
def main():
    ...
    with torch.no_grad():
        ...
        for img_path in tqdm(image_files):
            ...
            indices_dict = {}
            for class_id in [13, 14, 15, 7, 0]:
                indices_dict[f"indices_{class_id}"] = np.argwhere(pred == class_id)


            if opts.save_val_results_to:
                np.save(os.path.join(opts.save_val_results_to, img_name + '_indices.npy'), indices_dict)
